...
export const Typography: React.FC = () => {
  const typographyExamples = [
    {
      name: "H1 - Header",
      className: "text-[96px] font-[Geist] font-semibold leading-none",
      text: "The quick brown fox jumps over the lazy dog",
      description: "Font: Geist, Size: 96px, Weight: 600, Line Height: 1",
    },
    {
      name: "H2 - Header",
      className: "text-[64px] font-[Geist] font-semibold leading-none",
      text: "The quick brown fox jumps over the lazy dog",
      description: "Font: Geist, Size: 64px, Weight: 600, Line Height: 1",
    },
    {
      name: "H3 - Header",
      className: "text-[32px] font-[Geist] font-semibold leading-none",
      text: "The quick brown fox jumps over the lazy dog",
      description: "Font: Geist, Size: 32px, Weight: 600, Line Height: 1",
    },
    {
      name: "Body - Normal",
      className: "text-[22px] font-[Geist] font-normal leading-none",
      text: "The quick brown fox jumps over the lazy dog",
      description: "Font: Geist, Size: 22px, Weight: 400, Line Height: 1",
    },
    {
      name: "Body2",
      className: "text-[20px] font-[Geist] font-normal leading-none",
      text: "The quick brown fox jumps over the lazy dog",
