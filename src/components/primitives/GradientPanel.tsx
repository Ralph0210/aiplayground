...
type Variant = "hero" | "pastel1" | "pastel2"
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              ...
              // explicit ellipse: rx ry and centered
              backgroundImage:
                "radial-gradient( ellipse 65% 50% at 50% 50%, var(--color-accent-blue) 0%, color-mix(in srgb, var(--color-accent-blue) 65%, transparent) 40%, transparent 75% )",
              backgroundRepeat: "no-repeat",
              backgroundSize: "100% 100%",
              filter: "blur(300px)",
              opacity: 1,
          ...
          <div
            ...
            style={{
              ...
              transform: "rotate(-2deg)",
              backgroundImage:
                "radial-gradient( circle at 50% 50%, var(--color-accent-pink) 0%, color-mix(in srgb, var(--color-accent-pink) 60%, transparent) 40%, transparent 70% )",
              filter: "blur(140px)",
              opacity: 1,
              scale: "1.2",
            }}
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              ...
              // explicit ellipse: rx ry and centered
              backgroundImage:
                "radial-gradient( ellipse 65% 50% at 50% 50%, var(--color-primary-green) 0%, color-mix(in srgb, var(--color-primary-green) 65%, transparent) 40%, transparent 75% )",
              backgroundRepeat: "no-repeat",
              backgroundSize: "100% 100%",
              filter: "blur(300px)",
              opacity: 1,
          ...
          <div
            ...
            style={{
              ...
              transform: "rotate(-2deg)",
              backgroundImage:
                "radial-gradient( circle at 50% 50%, var(--color-primary-purple) 0%, color-mix(in srgb, var(--color-primary-purple) 60%, transparent) 40%, transparent 70% )",
              filter: "blur(130px)",
              opacity: 1,
              scale: "1.5",
            }}
          ...
          <div
            ...
            style={{
              ...
              transform: "rotate(-2deg)",
              backgroundImage:
                "radial-gradient( circle at 50% 50%, var(--color-primary-blue) 0%, color-mix(in srgb, var(--color-primary-blue) 60%, transparent) 40%, transparent 70% )",
              filter: "blur(140px)",
              opacity: 1,
              scale: "1.2",
            }}
